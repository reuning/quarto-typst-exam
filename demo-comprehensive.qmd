...
This section demonstrates the four-level question hierarchy using **sequential syntax**. You can also refer to specifc questions such as: `@q:first`{=typst} and `@q:second @q:sub`{=typst}

::: {.question points="10" label="q:first"}
...
::: {.subpart points="7" label="q:subpart"}
